...
const ApplicationsSection = () => {
        ...
        <div className="my-8 flex flex-col gap-6 text-white">
          {isLoading ? (
            ...
            pendingApplications.map((item) => (
              <div
                key={item.id}
                className="flex justify-between divide-x-2 border-4 rounded-lg bg-sky-800"
              >
        ...
        <div className="my-8 flex flex-col gap-6 text-white">
          {isLoading ? (
            ...
            acceptedApplications.map((item) => (
              <div
                key={item.id}
                className="flex justify-between divide-x-2 border-4 border-green-500 rounded-lg bg-sky-800"
              >
                {renderCandidateApplicationDetailsLeftSide(item)}
        ...
        <div className="my-8 flex flex-col gap-6 text-white">
          {isLoading ? (
            ...
            rejectedApplications.map((item) => (
              <div
                key={item.id}
                className="flex justify-between divide-x-2 border-4 border-red-500 rounded-lg bg-sky-800"
              >
                {renderCandidateApplicationDetailsLeftSide(item)}
  ...
  return (
    <div className="my-10">
      ...
      <div className="p-4 my-4 border-4 rounded-lg text-white bg-sky-800">
        <div className="flex flex-col gap-2 divide-y divide-white/40">
          {isLoading ? (
            ...
            applications.map((item) => (
              ...
              <span className="text-xl">Application is closed</span>
            )}
                  </p>
                </div>
                <div>
